CLASS zcl_ats_gs_datagenerator DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_ats_gs_datagenerator IMPLEMENTATION.
...
*        output =
  ...
  METHOD fill_master_data.
    data : lt_bp type table of zats_gs_bpa,
           lt_prod type table of zats_gs_prod.
   ...
   append value #(
    ...
    append value #(
     ...
     insert zats_gs_bpa from table @lt_bp.
     insert zats_gs_prod from table @lt_prod.
  ENDMETHOD.
  ...
  METHOD fill_transaction_data.
    data : o_rand type REF TO cl_abap_random_int,
           ...
           lv_ord_id type zats_gs_dte_id,
           lt_so type table of zats_gs_so_hdr,
           lt_so_i type table of zats_gs_so_item.
    ...
    select * from zats_gs_bpa into table @data(lt_bpa).
    select * from zats_gs_prod into table @data(lt_prod).
    ...
    insert zats_gs_so_hdr from table @lt_so.
    insert zats_gs_so_item from table @lt_so_i.

  ENDMETHOD.

  METHOD flush.
    delete from : zats_gs_bpa, zats_gs_prod, zats_gs_so_hdr, zats_gs_so_item.
  ENDMETHOD.
ENDCLASS.
